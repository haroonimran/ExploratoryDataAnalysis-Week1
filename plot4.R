...
par(mfrow = c(2,2))
plot(household_data$NewDate1,household_data$Global_active_power,type = "l",ylab = "Global Active Power (Kilowatts)", xlab = "")

plot(household_data$NewDate1,household_data$Voltage, type = "l",ylab = "Voltage", xlab = "datetime")
...
plot(household_data$NewDate1,household_data$Global_reactive_power, type = "l",ylab = "Global_reactive_power", xlab = "datetime")
